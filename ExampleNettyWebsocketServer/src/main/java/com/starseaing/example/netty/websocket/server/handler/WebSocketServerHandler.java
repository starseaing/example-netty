package com.starseaing.example.netty.websocket.server.handler;
...
public class WebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof FullHttpRequest) {
            log.info("channelRead0 FullHttpRequest");
    ...
    private void handleHttpRequest(ChannelHandlerContext ctx, FullHttpRequest req) throws Exception {
        ...
        // 构造握手响应返回，本机测试
        WebSocketServerHandshakerFactory wsFactory = new WebSocketServerHandshakerFactory("ws://localhost:8088/websocket",
                null, false);
